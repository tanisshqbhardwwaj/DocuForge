    ...
    <div className="auth-page">
      <div className="auth-left">
        ...
        <div className="auth-hero">
          <h1>Professional documents,<br /><span className="gradient-text">generated instantly.</span></h1>
          <p>Create invoices, purchase orders, and more with real-time preview and one-click PDF export.</p>
        ...
        <div className="auth-form-container">
          ...
          <form onSubmit={handleSubmit} className="auth-form" id="login-form">
            <div className="auth-field">
              <label htmlFor="login-email"><i className="fas fa-envelope"></i> Email address</label>
            ...
            <button type="submit" className="btn btn-auth" disabled={loading} id="btn-login">
